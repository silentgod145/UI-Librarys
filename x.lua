...
function Library:Overwrite()
    if game.CoreGui:FindFirstChild("FusionNotification") ~= nil then 
        TS:Create(Main,TweenInfo.new(0.5, Enum.EasingStyle.Sine, Enum.EasingDirection.Out),{Position = OriginalPos}):Play()
        game.TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
            BackgroundTransparency = 0.000
        }):Play() 
        game.TweenService:Create(Line, TweenInfo.new(0.5, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
            BackgroundTransparency = 0.000
        }):Play()
        game.TweenService:Create(Close, TweenInfo.new(0.5, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
            TextTransparency = 0.000
        }):Play()
        game.TweenService:Create(Textz, TweenInfo.new(0.5, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
            TextTransparency = 0.000
        }):Play()
        game.TweenService:Create(Titlez, TweenInfo.new(0.5, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
            TextTransparency = 0.000
        }):Play()
        FusionNotification:Destroy()
    end
end

function Library:Notify(xTitle, xText, xDuration)
    xTitle = xTitle or "Title"
    xText = xText or "Text"
    xDuration = xDuration or 5

    OriginalPos = UDim2.new(-0.99999999, 0, 0.80, 0)
    PosToGoTo = UDim2.new(-0.001*-65, 0, 0.80, 0)
    ...
    local Titlez = Instance.new("TextLabel")
    ...
    Main.Position = UDim2.new(0.023778921, 0, 0.777115524, 0)
    ...
    Textz.Name = "Text"
    Textz.Parent = Main
    Textz.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Textz.BackgroundTransparency = 1.000
    Textz.BorderSizePixel = 0
    Textz.Position = UDim2.new(0.0227272734, 0, 0.35555622, 0)
    Textz.Size = UDim2.new(0, 210, 0, 51)
    Textz.Font = Enum.Font.Gotham
    Textz.Text = xText
    Textz.TextColor3 = Color3.fromRGB(255, 255, 255)
    Textz.TextSize = 16.000
    Textz.TextWrapped = true
    Textz.TextXAlignment = Enum.TextXAlignment.Left
    Textz.TextYAlignment = Enum.TextYAlignment.Top
    Textz.TextTransparency = 1.000
    
    Line.Name = "Line"
    Line.Parent = Main
    Line.BackgroundColor3 = Color3.fromRGB(70, 70, 70)
    Line.BorderSizePixel = 0
    Line.Position = UDim2.new(0.0227272734, 0, 0.277777851, 0)
    Line.Size = UDim2.new(0, 210, 0, 2)
    Line.BackgroundTransparency = 1.000
    
    Titlez.Name = "Title"
    Titlez.Parent = Main
    Titlez.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Titlez.BackgroundTransparency = 1.000
    Titlez.BorderSizePixel = 0
    Titlez.Position = UDim2.new(0.0227272734, 0, 0, 0)
    Titlez.Size = UDim2.new(0, 186, 0, 25)
    Titlez.Font = Enum.Font.Gotham
    Titlez.Text = xTitle
    Titlez.TextColor3 = Color3.fromRGB(255, 255, 255)
    Titlez.TextSize = 18.000
    Titlez.TextXAlignment = Enum.TextXAlignment.Left
    Titlez.TextTransparency = 1.000
    ...
    Close.Position = UDim2.new(0.895454526, 0, 0.0333333351, 0)
    ...
    spawn(function()
        ...
        TS:Create(Main,TweenInfo.new(0.5, Enum.EasingStyle.Sine, Enum.EasingDirection.Out),{Position = PosToGoTo}):Play()
        game.TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
